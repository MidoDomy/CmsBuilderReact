...
const StyleShadowsBoxShadowItem: React.FC = () => {
          ...
          <Row gapX={6} align='center'>
            <Col fill>
              <Dropdown.Trigger className='block font-medium text-xs text-slate-500'>
                outset 0 0 2px 2px <span className='inline-flex w-2.5 h-2.5 ml-1 mr-0.5 bg-black'></span> black
              </Dropdown.Trigger>
            </Col>
            ...
            <Form.Group>
              <Row gapX={8} align='center'>
                <Col className='text-right'
                  span={2}
                >
                  <Form.Label size='sm'>Spread</Form.Label>
                </Col>
...
export default StyleShadowsBoxShadowItem;
