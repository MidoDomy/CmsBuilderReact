...
import CollectionsItemLayoutModalChange from './layout/CollectionsItemLayoutModalChange';
import ModalConfirmDeletion from 'layouts/general/ModalConfirmDeletion';

const CollectionsItemLayout: React.FC = () => {
  ...
  return (
    <>
      ...
      <CollectionsItemLayoutModalChange 
...
export default CollectionsItemLayout;
